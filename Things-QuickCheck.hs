...
-- Using |||=, ||=, and |= to check my answers
-- Ex 2 answer (is Universally correct) is correct
-- Ex 3 answer (is Tautology) is correct
-- Ex 4 answer (first is universal, second is not) is correct
